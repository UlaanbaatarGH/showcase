...
export const getSignInLockStatus = impl.getSignInLockStatus;
export const getUserHasEmail = impl.getUserHasEmail;
...
export const setItemFlag = impl.setItemFlag || (() => Promise.reject(new Error('setItemFlag: online only')));
